...
/// Dedicated Cyclone Points page: balance, earning rules and history.
class CyclonePointsScreen extends StatelessWidget {
  const CyclonePointsScreen({super.key});
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Cyclone Points')),
      body: wrapWeb(
        RefreshIndicator(
            ...
            children: [
              CyCard(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Row(children: [
                    ...
                    Text(auth.isPremium ? 'Premium member' : 'Free plan', style: const TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w700)),
                    const Spacer(),
                    StatusBadge(auth.isPremium ? 'premium' : 'free'),
                  ]),
                  const SizedBox(height: 10),
                  Text(
                    data.loyalty == null ? '•••' : data.points.toString(),
              ...
              if (data.loyalty == null)
                ...
                CyCard(
                  ...
                  child: Column(children: transactions.take(20).map((t) {
